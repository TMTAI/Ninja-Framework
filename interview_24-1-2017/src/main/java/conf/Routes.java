...
public class Routes implements ApplicationRoutes {
    ...
    public void init(Router router) {
        ...
        router.GET().route("/EpgDashboardConfiguration").with(EpgDashboardConfigurationController.class, "configuration");
        router.GET().route("/getAllReleaseWithUrl").with(EpgDashboardConfigurationController.class, "getReleaseWithUrl");
        router.POST().route("/addNewGreenHopperRelease").with(EpgDashboardConfigurationController.class, "addNewGreenHopperRelease");
        router.POST().route("/updateGreenHopperRelease").with(EpgDashboardConfigurationController.class, "updateGreenHopperRelease");
        router.POST().route("/deleteGreenHopperRelease").with(EpgDashboardConfigurationController.class, "deleteGreenHopperRelease");

        router.GET().route("/EpgDashboard").with(EpgDashboardController.class, "initEpgDashboard");
        router.GET().route("/EpgDashboard/updateCacheData").with(EpgDashboardController.class, "updateCacheData");
        router.GET().route("/EpgDashboard/getData").with(EpgDashboardController.class, "getReleaseSummaryDataFromDB");
        router.GET().route("/EpgDashboard/columnConfiguration").with(EpgDashboardController.class, "getColumnConfiguration");
        router.POST().route("/EpgDashboard/columnConfiguration").with(EpgDashboardController.class, "saveColumnConfiguration");
