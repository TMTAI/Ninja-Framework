    ...
    if (!dataTable.loading) {
        dataTable.ajax = $.ajax({
            ...
            success: function (responseData) {
                ...
                var epicKeys = [];
                if(jsonObjectForUsTable.data) {
                	epicKeys = Object.keys(jsonObjectForUsTable.data).sort();
                }
                $.each(epicKeys, function (index, epicKey) {
                	var storyArray = jsonObjectForUsTable.data[epicKey];
